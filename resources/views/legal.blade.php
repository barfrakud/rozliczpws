    ...
    <div class="container">
        <div id="podstawaPrawnaDivId" class="mt-5 legal-page">
            <div class="intro legal-card">
                ...
                <p>
                    Kalkulator delegacji służbowej <strong>{{ config('app.display_name') }}</strong> ułatwia rozliczenie kosztów wyjazdu
                    służbowego
                    pracownika w oparciu o wprowadzone do formularza parametry. <br><br>
                </p>
                <p>
                    Obliczenia mają charakter pomocniczy i autor strony {{ config('app.display_name') }} nie ponosi odpowiedzialności za
                    prawidłowość
