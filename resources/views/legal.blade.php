...
@section('content')
    <div class="container">
        <div id="podstawaPrawnaDivId" class="container mt-5">
            ...
            <p>
                Kalkulator delegacji służbowej <strong>rozliczPWS.pl</strong> ułatwia rozliczenie kosztów wyjazdu służbowego
            ...
            W przypadku wykrytych błędów proszę o kontakt poprzez profil na Facebook (w zakładce Kontakt). <br><br>
            ...
            <p>
                <strong>PODRÓŻ ZAGRANICZNA</strong>
            </p> <br>
            <p>
                § 12.
            </p>
