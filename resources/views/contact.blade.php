    ...
    <div class="container">
        <div class="content">
            <div class="row">
                ...
                <p class="mt-3">Jeśli znalazłeś błąd lub masz pomysł co można lepiej zrobić, to proszę napisz do mnie
                    poprzez formularz
                    poniżej.</p>
                <p>Podając email będę mógł z Tobą nawiązać kontakt, aby ewentualnie wyjaśnić problem i w przyszłości
                    powiadomić Cię, że
                    rozliczpws.pl działa już poprawnie!</p>
            </div>
            <div class="row">
                <div class="col-md-12">
